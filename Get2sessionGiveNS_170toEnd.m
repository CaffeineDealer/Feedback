...
Fs = 10000;
name = 'ytu337';
path = 'E:\MT_MST\SuperTuneFiringMatrix\ms_rmvd_170toEnd\';
pathspk = 'E:\MT_MST\SuperTuneSpkTrains\ms_rmvd_170toEnd\';
...
for i = 1:length(ch)
    ...
    load([pathspk,name,'a',num2str(ch(i)),'1','spktrain.mat']); aspk = spktrain(tendMS:end,:,1:2,:,:); %send vs end
    load([pathspk,name,'b',num2str(ch(i)),'1','spktrain.mat']); bspk = spktrain(tendMS:end,:,1:2,:,:); %send vs end

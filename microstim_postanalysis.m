...
clear all; clc
fldname = 'D:\MT_MST\Microstim\Norm\MUA_SUA\';
% fldname = 'D:\MT_MST\Microstim\PSTH\MUA-MST-V1V2\Norm\';
param.mua_sua = 1;
param.type = 'trans';
param.option = '';
[N,S] = LoadDataset(fldname,param);
%% Vector average: Preferred Direction MT
svpath = 'D:\MT_MST\Microstim\PSTH\MUA_SUA\Norm\';
% svpath = 'D:\MT_MST\Microstim\PSTH\MUA-MST-V1V2\Norm\';
[badCell,theta] = mtpd(N,S,svpath,0,param.option,param.type);
...
% save(['D:\MT_MST\Microstim\PSTH\MUA_SUA\',sprintf('cmass_%s_%sn.mat',type(1),option)],'Vx','Vy','diffV')
%% RF MST
S = N;
[Vx Vy diffV] = RF(S,N,badCell,type,theta,0);
save(['D:\MT_MST\Microstim\PSTH\ms_rmvd_150300\',sprintf('cmass_%s_%s.mat',type(1),option)],'Vx','Vy','diffV')
% save(['D:\MT_MST\Microstim\PSTH\MUA-MST-V1V2\',sprintf('mst_RFcmass_%s%s.mat',type,option)],'Vx','Vy','diffV')
%% Position @ PDirection
clear all; clc
...
clear all; clc
datapath = 'D:\MT_MST\Microstim\PSTH\MUA_SUA\'; %ms_rmvd_150300
type = 'trans';
MS = 1;
...
%%
clear all; clc
datapath = 'D:\MT_MST\Microstim\PSTH\ms_rmvd_150300\';
MS = 0;
type = 'trans';
...
clear all; clc
% datapath = 'D:\MT_MST\Microstim\PSTH\MUA-MST-V1V2\';
datapath = 'D:\MT_MST\Microstim\PSTH\MUA_SUA\';
MS = 1;
type = 'trans';
...
clear all; clc
datapath = 'D:\MT_MST\Microstim\PSTH\MUA_SUA\';%ms_rmvd_150300
svpath = 'D:\MT_MST\Microstim\Norm\MUA_SUA\MST\';
...
clear all; clc
datapath = 'D:\MT_MST\Microstim\Norm\MUA_SUA\MST\';
...
clear all; clc
datapath = 'D:\MT_MST\Microstim\PSTH\ms_rmvd_170toEnd\';%ms_rmvd_150300 or E:\MT_MST\Microstim\PSTH\MUA_SUA\;
svpath = 'D:\MT_MST\Microstim\PSTH\ms_rmvd_170toEnd\Normalized\';%'D:\MT_MST\Microstim\Norm\MUA_SUA\'; 
% datapath = 'D:\MT_MST\Microstim\PSTH\MUA-MST-V1V2\';
% svpath = 'D:\MT_MST\Microstim\PSTH\MUA-MST-V1V2\Norm\';
% datapath = 'D:\MT_MST\Microstim\PSTH\MUA-MST-V1V2\Norm\';
% svpath = 'D:\MT_MST\Microstim\PSTH\MUA-MST-V1V2\Norm\';
...
clear all; clc
% datapath = 'D:\MT_MST\Microstim\PSTH\MUA_SUA\Norm\'; % MUA-MST-V1V2 / ms_rmvd_150300 / MUA_SUA
datapath = 'D:\MT_MST\Microstim\PSTH\MUA-MST-V1V2\Norm\';
% datapath = 'D:\MT_MST\Microstim\PSTH\MUA-MST-V1V2\';
% datapath = 'D:\MT_MST\Microstim\PSTH\MUA_V1\';
...
[cort] = masterPlotPos(MSTt,MTtnms,MTtms,'Translation');
[cors] = masterPlotPos(MSTs,MTsnms,MTsms,'Spiral');
...
switch option
    case 'MS'
        ...
        save(['D:\MT_MST\Microstim\PSTH\msr\mt-mst\',sprintf('trMST_%s_%s.mat',type(1),option)],'trMST','tr')        
end
...
switch option
    case 'MS'
        ...
        save(['D:\MT_MST\Microstim\PSTH\ms_rmvd_150300\',sprintf('trMST_%s_%s.mat',type(1),option)],'trMST','tr')      % MUA-MST-V1V2  
end
%% PD difference between MST(NoMS) & MT(NoMS & MS): Part II
clear all; clc
datapath = 'D:\MT_MST\Microstim\PSTH\MUA_SUA\Norm\'; % MUA-MST-V1V2 / ms_rmvd_150300 / MUA_SUA
...
%% PD difference between MST(NoMS) & MT(NoMS & MS): Part II
clear all; clc
% load(['D:\MT_MST\Microstim\PSTH\MUA_SUA\' 'trMST_t_MS.mat']); trMSTt = trMST; clear trMST % MUA-MST-V1V2
% load(['D:\MT_MST\Microstim\PSTH\MUA_SUA\' 'trMST_s_MS.mat']); trMSTs = trMST; clear trMST
load(['D:\MT_MST\Microstim\PSTH\ms_rmvd_150300\' 'theta_t_MS.mat']); trMSTt = theta; clear trMST % MUA-MST-V1V2
load(['D:\MT_MST\Microstim\PSTH\ms_rmvd_150300\' 'theta_s_MS.mat']); trMSTs = theta; clear trMST
load(['D:\MT_MST\Microstim\PSTH\ms_rmvd_150300\' 'theta_t_.mat']); trMTt = theta; clear theta
load(['D:\MT_MST\Microstim\PSTH\ms_rmvd_150300\' 'theta_s_.mat']); trMTs = theta; clear theta
...
% save('D:\MT_MST\Microstim\PSTH\MUA_V1\pdDiff.mat','pdDiff')
% save('D:\MT_MST\Microstim\PSTH\MUA_V1\pdD.mat','pdD')
%%%% Plot Section %%%%
figure
subplot(1,2,1)
...
% S = N;
[Vx Vy diffV] = RF(S,N,badCell,type,theta,0);
save(['D:\MT_MST\Microstim\PSTH\MUA_V1\',sprintf('mst_RFcmass_%s%s.mat',type,option)],'Vx','Vy','diffV')
%%
[Vx Vy diffV] = RFcentered(S,N,badCell,type,theta,1);
%% Tuning curves: MT & MST : Translation & Spiral : No-MicroStim & MicroStim
clear all; clc
load('D:\MT_MST\Microstim\PSTH\MUA_SUA\ctl_MT.mat'); % msr\mt-mst
load('D:\MT_MST\Microstim\PSTH\MUA_SUA\MT.mat')
load('D:\MT_MST\Microstim\PSTH\MUA_SUA\pdDiff.mat')
load('D:\MT_MST\Microstim\PSTH\MUA_SUA\pdD.mat')
load('D:\MT_MST\Microstim\PSTH\MUA_SUA\trMST_t_MS.mat','tr'); trt = tr; clear tr
load('D:\MT_MST\Microstim\PSTH\MUA_SUA\trMST_s_MS.mat','tr'); trs = tr; clear tr
type = 'spiral';
...
for i = 1:size(names,2) 
    ...
    info(i).MTcell = load(['D:\MT_MST\Microstim\Cell_Lib\MST_MU_MT_SU\MT\','CLib_',names{1,i}(1:end-1),'.mat']); % MS_removed\Candidate Cells
    info(i).MSTcell = load(['D:\MT_MST\Microstim\Cell_Lib\MST_MU_MT_SU\MST\','CLib_',names{1,i}(1:end-1),'.mat']); % MS_removed\MS Cells
...
pathInfo = 'D:\MT_MST\Microstim\PSTH\n\';
...
for i = 1:size(names,2)
    ...
    save(['D:\MT_MST\Microstim\PSTH\',sprintf('%sChunum%s%s.mat',names{i}(1:end-1)),cond,flag],'chunum')
    save(['D:\MT_MST\Microstim\PSTH\',sprintf('%sPos%s%s.mat',names{i}(1:end-1),cond,flag)],'pos')
    clear chunum pos
end
%% Create MT.mat
clear all; clc
...
save(['D:\MT_MST\Microstim\PSTH\MUA_SUA\MT.mat'],'MT')
%% CMass stuff
VxMT = Vx_s_mt;
VyMT = Vy_s_mt;
...
for i = 1:length(names)
    fn = names{i};
    a = struct2array(load(['D:\MT_MST\SuperTuneFiringMatrix\fixation\',fn(1:end-1),'cfr.mat']));
    frn = [frn;a(:,:,1)]; %N
    frs = [frs;a(:,:,2)]; %S
    ncell(i,1) = size(a,1);
end

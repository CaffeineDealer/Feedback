...
load(['D:\MT_MST\Plexon\TrialStructs\' sprintf('%s_TrialStructure.mat',fname)])
cd D:\MT_MST\Plexon\PLXfiles
...
% load(['D:\MT_MST\Plexon\PDataMat\' sprintf('%sPData_despike.mat',fname)]);
